...
Feature: Expense dashboard
  ...
  Scenario: an authenticated user with sufficient permissions retrieves his expenses
    ...
    Then he gets a response with status 200
    And he receives a list of 5 expenses
    ...
    And he receives a list of expenses containing at index 2 an expense with 15/04/2021, 27.50, courses, "Courses @ Carrefour", true and false
    And he receives a list of expenses containing at index 3 an expense with 01/05/2021, 3.50, frais_bancaire;Belfius, "frais de gestion compte à vue", false and false
    And he receives a list of expenses containing at index 4 an expense with 01/04/2021, 3.50, frais_bancaire;Belfius, "frais de gestion compte à vue", false and false