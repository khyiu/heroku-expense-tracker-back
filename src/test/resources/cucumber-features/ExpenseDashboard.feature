...
Feature: Expense dashboard
  ...
  Scenario: an authenticated user with sufficient permissions retrieves his expenses
    ...
    And he receives a list of expenses containing at index 1 an expense with 01/05/2021, 3.50, frais_bancaire;Belfius, "frais de gestion compte à vue", false and false