...
Feature: Expense dashboard
  Scenario: a non authenticated user retrieves his expenses
    ...
    When he sends a request to retrieve his expenses with page number=1, page size=1, sortBy=DATE, sortDirection=DESC, tag filters=null, description filters=null, date lower bound=null, date upper bound=null, checked status=null, paid with credit card=null and credit card statement issued=null
  ...
  Scenario: an authenticated user with sufficient permissions retrieves his expenses
    ...
    When he sends a request to retrieve his expenses with page number=1, page size=2, sortBy=AMOUNT, sortDirection=DESC, tag filters=null, description filters=null, date lower bound=null, date upper bound=null, checked status=null, paid with credit card=null and credit card statement issued=null
    Then he gets a response with status 200
    ...
    When he sends a request to retrieve his expenses with page number=2, page size=2, sortBy=AMOUNT, sortDirection=DESC, tag filters=null, description filters=null, date lower bound=null, date upper bound=null, checked status=null, paid with credit card=null and credit card statement issued=null
    Then he gets a response with status 200
    And he receives a list of 2 expenses
    And he receives a list of expenses containing at index 0 an expense with 15/04/2021, 27.50, courses, "Courses @ Carrefour", true, false and null
